...
class OrgEventDetailsScreen extends StatefulWidget {
  // final Event event;
  ...
  @override
  State<OrgEventDetailsScreen> createState() => _EventDetailsScreenState();
}

class _EventDetailsScreenState extends State<OrgEventDetailsScreen> {
                    ...
                    builder: (BuildContext context) => AlertDialog(
                          ...
                          actions: <Widget>[
                            ...
                            TextButton(
                                onPressed: () {
                                  if (_isMounted) {
                                    db.deleteEvent(event.eventId).then((value) {
                                      if (_isMounted) {
                                        Navigator.popUntil(
